...
int main()
{
    ...
    std::cout << "[After] Best path length " << best_genome_last_generation.first << "\n[After] Best genome: "<< best_genome_last_generation.second << std::endl;
    ...
    export_best_path(best_genome_cur_generation.second);
    return 0;
}